...
/* For Simple Link */
#define CONFIG_INCLUDE_SIMPLE_CONFIG		0//1

/*For fast reconnection*/
#define CONFIG_EXAMPLE_WLAN_FAST_CONNECT	1//0
...
#define CONFIG_EXAMPLE_UART_ATCMD	1//0
...
#define LOG_SERVICE_BUFLEN 300//1600
...
/* Simple Example UDP Send */
#define CONFIG_EXAMPLE_UDP_SEND			0

/* For LwIP App mDNS example */
#define CONFIG_EXAMPLE_LWIP_APP_MDNS	0//1

/* For LwIP App MQTT example */
#define CONFIG_EXAMPLE_LWIP_APP_MQTT	0//1
