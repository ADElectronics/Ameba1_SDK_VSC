...
#include "udp_send/example_udp_send.h"
#endif

#if CONFIG_EXAMPLE_LWIP_APP_MDNS
#include "lwip_app_mdns/example_lwip_app_mdns.h"
#endif

#if CONFIG_EXAMPLE_LWIP_APP_MQTT
#include "lwip_app_mqtt/example_lwip_app_mqtt.h"
#endif
...
#if CONFIG_EXAMPLE_LWIP_APP_MDNS
	example_lwip_app_mdns();
#endif

#if CONFIG_EXAMPLE_LWIP_APP_MQTT
	example_lwip_app_mqtt();
#endif
}
