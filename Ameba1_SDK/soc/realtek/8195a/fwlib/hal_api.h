...
extern _LONG_CALL_ int HalSerialPutcRtl8195a(IN u8 c);
...
extern _LONG_CALL_ VOID VectorTableInitForOSRtl8195A(IN VOID *PortSVC, IN VOID *PortPendSVH, IN VOID *PortSysTick);
