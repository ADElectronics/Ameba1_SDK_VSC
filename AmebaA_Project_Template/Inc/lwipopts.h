...
// Различные дефайны, необходимые для 2.1.2
...
// Различные дефайны для использования Apps из 2.1.2 версии
#define LWIP_MDNS_RESPONDER                     1
#define LWIP_NUM_NETIF_CLIENT_DATA              1

// for ping 10k test buffer setting
 ...
 */
#define LWIP_RANDOMIZE_INITIAL_LOCAL_PORTS      1 // Realtek modified
...
#define LWIP_SRAND()                            Rand() // srand(sys_now())
